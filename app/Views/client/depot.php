...
<div class="mm-form-card mx-auto">
  <div class="mm-form-header mm-form-header--depot">
  ...
  <form action="/client/depot" method="post" id="operationForm" data-type="depot" novalidate>
    <?= csrf_field() ?>
    ...
    <div class="mb-3">
      ...
      <div class="invalid-feedback" id="montantError">Montant invalide.</div>
    </div>
